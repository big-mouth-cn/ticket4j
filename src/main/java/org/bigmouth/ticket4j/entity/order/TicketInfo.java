...
public class TicketInfo implements Serializable {
    ...
    private static final long serialVersionUID = 3818985540320215584L;
    ...
    public void setStationTrainDTO(StationTrain stationTrainDTO) {
    ...
    public void setPassengerDTO(Passenger passengerDTO) {
